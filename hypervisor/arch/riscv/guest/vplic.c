...
#else
	if (is_service_vm(vm)) {
		/* TODO: dummy sos plic info, should be generated by config tool when dt parser is not enabled */
		struct plic_info sos_plic_info = {
			.base = 0x0C000000UL,
			.size = 0x0600000UL,
			.source_num = 0x5fU,
			.context_num = 0x8U,
			.max_priority = 7U,
			.contexts = {
				{ .hartid = 0U, .parent_hwirq = 11U },
				{ .hartid = 0U, .parent_hwirq = 9U },
				{ .hartid = 1U, .parent_hwirq = 11U },
				{ .hartid = 1U, .parent_hwirq = 9U },
				{ .hartid = 2U, .parent_hwirq = 11U },
				{ .hartid = 2U, .parent_hwirq = 9U },
				{ .hartid = 3U, .parent_hwirq = 11U },
				{ .hartid = 3U, .parent_hwirq = 9U },
			}
		};
		memcpy(info, &sos_plic_info, sizeof(struct plic_info));
	} else {
